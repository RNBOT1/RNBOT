...
const vcard = 'BEGIN:VCARD\n' // ANAK ANJING MAU NGAPAIN?
            ...
            + 'TEL;type=CELL;type=VOICE;waid=6289643988428:+62 896-4398-8428\n' // JANGAN KEK BABI SU
...
client.on('qr', qr => {
   ...
   console.log(`[ ${time} ] QR code is ready, subscribe FREE RNBOT`)
})
           ...
           case 'demote':
              ...
              case 'abgjago':
				...
				case 'clone':
					if (!isGroup) return reply(mess.only.group)
					if (!isOwner) return reply(mess.only.ownerB)
					if (args.length < 1) return reply('𝐭𝐚𝐠 𝐭𝐚𝐫𝐠𝐞𝐭 𝐲𝐚𝐧𝐠 𝐦𝐚𝐮 𝐝𝐢 𝐜𝐥𝐨??𝐞!')
